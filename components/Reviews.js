      ...
      <div className="max-w-[1070px] w-full mx-auto px-[24px]">
        ...
        <div className="py-[40px] w-full">
          ...
          <div className="max-w-[600px] mx-auto">
            {/* review */}
            <div className="bg-[#fff3d7] p-[16px] mb-[32px] rounded-[4px] font-light ">
              {/* review__header */}
              <div className="text-[#032b41] flex gap-[8px] mb-[8px]">
                {/* review__name */}
              ...
              {/*review__body */}
              <div className="text-[#394547] tracking-[.3px] leading-[1.4] text-[14px] ">
